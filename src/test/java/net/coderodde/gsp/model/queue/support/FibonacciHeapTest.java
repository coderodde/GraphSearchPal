...
public class FibonacciHeapTest {
    ...
    private final FibonacciHeap<Integer> heap;
    ...
    public static void initClass() {
        System.out.println("FibonacciHeapTest.java, seed: " + seed);
    }
    ...
    public void testSpawn() {
        ...
        FibonacciHeap<Integer> heap2 = (FibonacciHeap<Integer>) heap.spawn();
        
        assertTrue(heap2 instanceof FibonacciHeap);
        assertFalse(heap.isEmpty());
